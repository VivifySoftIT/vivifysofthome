<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Reportform.aspx.cs" Inherits="LTG.Reportform" %>
  ...
  <a class="nav-link" href="SmithReport.aspx">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <div class="custom-dropdown-wrapper">
                                            <input type="text" id="regionSearchInput" class="filter-control" placeholder="All Regions" value="" />
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <div class="custom-dropdown-wrapper">
                                            <input type="text" id="branchSearchInput" class="filter-control" placeholder="All Branches" value="" />
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <div class="custom-dropdown-wrapper">
                                            <input type="text" id="employeeSearchInput" class="filter-control" placeholder="All Employees" value="" />
    ...
    <script>
        $(document).ready(function () {
            ...
            // Set initial values from hidden dropdowns
            updateSearchInputValues();
        });

        function updateSearchInputValues() {
            var regionText = $('#<%= ddlRegion.ClientID %> option:selected').text();
            var branchText = $('#<%= ddlBranch.ClientID %> option:selected').text();
            var employeeText = $('#<%= ddlEmployee.ClientID %> option:selected').text();
            
            $('#regionSearchInput').val(regionText);
            $('#branchSearchInput').val(branchText);
            $('#employeeSearchInput').val(employeeText);
        }
